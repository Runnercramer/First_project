...
<head>
    ...
    <style>
        ...
        .contact_info{width:60%;text-align:center;margin:10px;font-size:1em;border-radius:15px;}
        .payment_button{display:block;background-color:lightblue;color:black;width:200px;font-weight:bold;font-size:1.5em;border-radius:15px;margin:30px auto;padding:5px;box-shadow:5px 5px 15px 5px #333;}
        .payment_button:hover{background-color:#6fbbd3;}
        .payment_button:active{background-color:black;color:white;}
        .cart_form{font-size:1.5em;background-color:#999;}
    </style>
    <script>
    function logout(){
...
<body>
    ...
    <div id='cont1'>
        <header id='enc1'>
            <a href='vista_creacion_pedido.php'><img id='img1' src='../../../imagenes/descarga.png' alt='Logotipo de Vetex'></a>
            <h1>Carrito</h1>
            <div class="profile">
        ...
        <section class="methods">
            ...
            <div class="cart_container">
                <table class='main_table'>
                    ...
                    <tr>
                        <td colspan="6">
                            <form class='cart_form' action="pagar.php" method="POST">
                                <label>Código del pedido</label>
                                <br>
                                <input class='contact_info' type="text" name="codpedido" placeholder="Ingrese el código XX-XXX" required>
                                <br>
                                <label>Código del cliente</label>
                                <br>
                                <input class='contact_info' type="number" name="idcliente" placeholder="Ingrese el código del cliente" required>
