...
<html lang='es'>
<head>
    <title>Habilitar productos</title>
    <meta charset='UTF-8' />
...
<body>
    ...
    $sql1 = "SELECT * FROM producto pr JOIN detalleproducto dp ON pr.codProducto = dp.codProducto WHERE estadoProducto = 'deshabilitado' ORDER BY producto ASC";
    ...
    $sql1_limite = "SELECT * FROM producto pr JOIN detalleproducto dp ON pr.codProducto = dp.codProducto WHERE estadoProducto = 'deshabilitado' ORDER BY producto ASC LIMIT $empezar_desde,$tamaño_pagina";
    ...
    if(isset($_POST['state'])){
        ...
        for($i = 0; $i < $cant; $i++){
            $cod = $_POST['state'][$i];
            $sql = "UPDATE producto SET estadoProducto = 'habilitado' WHERE codProducto = '$cod'";
    ...
    <div id='cont1'>
        <header id='enc1'>
            ...
            <h1>Hay <?php echo $num_filas?> productos deshabilitados</h1>
            <div class="profile">
        ...
        <section class="methods">
            <div class="information">
                ...
                <br>
                <p>Este es un listado con los productos que están deshabilitados por orden del administrador o por falta de existencias.<br><b>Los productos deshabilitados no se mostrarán en los catálogos de compra.</b></p>
                <br>
