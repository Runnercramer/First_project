...
<head>
    ...
    <style>
        .lista_saldos{border:1px solid black;width:90%;margin:10px auto;display:grid;grid-template-columns:repeat(2, 1fr);grid-template-rows:50px 1fr 1fr 1fr;background-color:#ddd;}
        .first_column{border:1px solid blue;text-align:center;}
        .second_column{bordeR:1px solid red;text-align:center;}
    </style>
</head>
<body>
    <?php
